...
function initSurveyLocale(){
	var jsonEditor = JSON.parse(surveyData.creator_json);

	if(jsonEditor.hasOwnProperty('locale') && !isNullOrEmpty(jsonEditor.locale)){
		Survey.surveyLocalization.defaultLocale=jsonEditor.locale;
	}
	else{
